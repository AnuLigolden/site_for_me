...
class Post(models.Model):
    ...
    short_description=models.CharField(max_length=500, verbose_name='Descripton')
    ...
    image=models.ImageField(upload_to='product_images/', verbose_name='Image', blank=False)
...
class Comment(models.Model):
    ...
    def __str__(self):
        return 'Коментар     про     '.format(self.name, self.post)
